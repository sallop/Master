...
int main(int argc, char **argv)
{
  ...
  char prefix[32]="k11", odir[32] = "dir-dat";
...
//   prob_Q[8+0]=0.10; prob_Q[8+1]=0.10; prob_Q[8+2]=0.05; prob_Q[8+3]=0.05;
//   prob_Q[8+4]=0.10; prob_Q[8+5]=0.10; prob_Q[8+6]=0.40; prob_Q[8+7]=0.10;
