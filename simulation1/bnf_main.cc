...
FILE* plot_status(FILE *gp, int time,
		  ...
		  SubLayer& J, Layer& Ja, Layer& Jd, Layer& Jm)
{
  fprintf(gp, "set title 'b1-%d'\n",time);
  fprintf(gp, "set terminal gif enhanced animate\n");
  fprintf(gp, "set output 'dir-dat/b1-LWJ.gif'\n");
